...
exports.handler = function(event, context) {
    ...
    let intentParams = [
        ...
        {
            "name": "bookconsultation" + "_" + process.env.ENV,
            
            "confirmationPrompt": {
                "maxAttempts": 2, 
                "messages": [
                    {
                        "content": "are you sure you want to book a consultation for doctor specialised in {part}", 
            ...
            "rejectionStatement": {
                "messages": [
                    {
                    "content": "your consultation will not be booked", 
                    "contentType": "PlainText"
                    }
                ]
            }, 
            ...
            "slots": [
                
                {
                    ...
                    "valueElicitationPrompt": {
                        ...
                        "messages": [
                            {
                                "content": "which part of the body do you feel uncomfortable?",
                                "contentType": "PlainText"
                            }
                        ]
                    }
                ...
                
                {
                    ...
                    "valueElicitationPrompt": {
                        ...
                        "messages": [
                            {
                                "content": "can you describe your symptom?",
                                "contentType": "PlainText"
                            }
                        ]
                    }
    ...
    let botParams = {
        ...
        "intents": [
            ...
            {
                "intentName": "bookconsultation" + "_" + process.env.ENV,
...
function ensureLambdaFunctionAccess(intent){
    if(intent.fulfillmentLambda){
        ...
        const params = {
            ...
            StatementId: `Lex-${intent.name}`+ "ff1eb575",
