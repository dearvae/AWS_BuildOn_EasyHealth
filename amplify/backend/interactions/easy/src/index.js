...
exports.handler = function(event, context) {
    ...
    let intentParams = [
        ...
        {
            "name": "doctor" + "_" + process.env.ENV,
            
            "confirmationPrompt": {
                "maxAttempts": 2, 
                "messages": [
                    {
                        "content": "do you want to have a consultation with our {part} doctor?", 
            ...
            "slots": [
                
                {
                    ...
                    "valueElicitationPrompt": {
                        ...
                        "messages": [
                            {
                                "content": "Which part of your body do you find uncomfortable?",
                                "contentType": "PlainText"
                            }
                        ]
                    }
    ...
    let botParams = {
        ...
        "intents": [
            ...
            {
                "intentName": "doctor" + "_" + process.env.ENV,
...
function ensureLambdaFunctionAccess(intent){
    if(intent.fulfillmentLambda){
        ...
        const params = {
            ...
            StatementId: `Lex-${intent.name}`+ "fd07ac69",
